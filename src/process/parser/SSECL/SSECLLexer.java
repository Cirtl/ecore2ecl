...
public class SSECLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"BLOCK", "TO", "FROM", "ID", "INT", "SEQ", "WS", "LINE_COMMENT", "MULT_COMMENT"
		};
	}
	...
	public SSECLLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "SSECL.g4"; }
